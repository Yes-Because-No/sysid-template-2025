...
public class Arm extends SubsystemBase {
    ...
    private final MutAngle sysIdPosition = MutableMeasure.mutable(Radians.of(0));
    private final MutAngularVelocity sysIdVelocity = MutableMeasure.mutable(RadiansPerSecond.of(0));
